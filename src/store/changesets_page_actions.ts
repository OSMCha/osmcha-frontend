...
export function* watchChangesetsPage(): any {
  yield all([
    takeLatest(CHANGESETS_PAGE.fetch, fetchChangesetsPageSaga as any),
    takeLatest(CHANGESETS_PAGE.modify, modifyChangesetPageSaga as any),
    takeLatest(CHANGESETS_PAGE.checkNew, checkForNewChangesetsSaga as any),
  ]);
}
