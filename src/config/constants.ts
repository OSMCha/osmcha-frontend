...
export const enableRealChangesets =
  !import.meta.env.VITE_DISABLE_REAL_CHANGESETS;
...
export const DEFAULT_FROM_DATE = Number(import.meta.env.VITE_DEFAULT_FROM_DATE) || 2;
...
export const DEFAULT_TO_DATE = Number(import.meta.env.VITE_DEFAULT_TO_DATE) || 5;
